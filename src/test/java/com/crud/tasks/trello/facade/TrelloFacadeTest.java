...
import com.crud.tasks.repository.service.TrelloService;
...
class TrelloFacadeTest {
    ...
    void shouldCreateTrelloCard() {
        ...
        when(trelloService.createTrelloCard(testCardDto)).thenReturn(cardDto);


        //When
        CreatedTrelloCardDto createdTrelloCardDto = trelloFacade.createCard(testCardDto);
